...
export default function Services() {
    ...
    return (
        <>
            ...
            <h2 className='text-5xl mt-8 mb-12 font-semibold'>{splitTextIntoWords(t("services-section.services.main-title"))}<strong className='text-beige'>{splitTextIntoWords(t("services-section.services.main-title-strong"))}</strong>  </h2>
