            ...
            <Inner>
                <div className="lg:px-24 px-12">
                        ...
                        <div className="text-right font-semibold text-3xl p-4 pb-24 text-anthra 
                         lg:text-5xl lg:ml-24">
                            ...
                            <div className=" flex justify-end space-x-4 my-8">
                                <Link href="#my-work"><Button>{splitTextIntoWords(t("slogan.discover"))}</Button></Link>
                    ...
                    <div className="w-full">
                        ...
                        <Article />
                        <section className="flex justify-center items-center lg:flex-row flex-col lg:space-x-24 lg:mb-12">
